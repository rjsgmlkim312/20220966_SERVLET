...
<div class="form-group row">
	...
	<div class="col-sm-3">
        ...
        <br>
        <button type="button" onclick="checkDeliveryDate()">확인</button>
            <script>
        function checkDeliveryDate() {
            ...
            currentDate.setDate(currentDate.getDate() + 1); // 내일 날짜 계산

            if (selectedDate < currentDate) {
                dateError.innerHTML = "배송일은 반드시 24시간 이후여야 합니다.";
                deliveryDateInput.value = ""; // 날짜 필드를 비움
            } else {
                dateError.innerHTML = "";
            }
        }
